        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="hidden md:flex items-center gap-1.5">
              ...
              >
                ...
                <kbd className="hidden xl:block px-1 py-0.5 rounded border border-border bg-accent text-[10px] font-mono text-muted-foreground">
                  ⌘K
                </kbd>
              </button>
          ...
          <div className="md:hidden h-10 flex items-center overflow-x-auto no-scrollbar border-t border-border/60">
            <nav className="flex items-center gap-1 text-xs text-muted-foreground whitespace-nowrap">
              <Link
                href="/"
                className={`inline-flex items-center gap-1 px-1.5 py-1 rounded ${pathname === "/" ? "text-primary font-medium" : ""}`}
              >
              ...
              {mobileCrumbs.map((segment, index) => {
                ...
                return (
                  <React.Fragment key={href}>
                    ...
                    <Link
                      href={href}
                      className={`px-1.5 py-1 rounded ${pathname === href ? "text-primary font-medium" : ""}`}
                    >
