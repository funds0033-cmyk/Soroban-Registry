...
export function MobileDrawer({
  ...
  return (
    ...
    >
      ...
      <div
        className={`${styles.drawerPanel} ${isOpen ? "translate-x-0" : "translate-x-full"}`}
        role="dialog"
        aria-modal="true"
      >
            ...
            <nav className="flex flex-col gap-0.5">
              {[
                ...
                >
                  ...
                  >
                    <Icon
                      className={`w-3.5 h-3.5 ${pathname === href ? "text-primary" : ""}`}
                    />
                  </span>
                  {label}
                  {count > 0 && (
        ...
        <div className="border-t border-border p-4 bg-accent/20">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link
              href="/publish"
              onClick={onClose}
              className="flex items-center justify-center gap-1.5 py-2.5 rounded-lg bg-primary text-primary-foreground font-semibold text-sm"
            >
