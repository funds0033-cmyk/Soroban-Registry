  ...
  return (
    <div className="hidden md:flex items-center gap-0.5" role="menubar">
      ...
      >
        ...
        <div
          className={`absolute top-full left-1/2 -translate-x-1/2 w-48 pt-1.5 transition-all duration-150 ${exploreOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2 pointer-events-none"}`}
        >
