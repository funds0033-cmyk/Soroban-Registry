...
export default function DeploymentTimeline({
  ...
  const [viewWindow, setViewWindow] = useState<"7d" | "30d" | "90d" | "all">(
    "30d",
  );
      ...
      <div className="px-6 py-4 border-b border-border flex flex-col md:flex-row md:items-center justify-between gap-4 bg-muted/20">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Historical view of registry submissions
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <select
            value={viewWindow}
            onChange={(e) =>
              setViewWindow(e.target.value as "7d" | "30d" | "90d" | "all")
            }
            ...
            {filteredContracts.map((contract) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Stalk (vertical line) */}
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-px h-6 bg-border" />
