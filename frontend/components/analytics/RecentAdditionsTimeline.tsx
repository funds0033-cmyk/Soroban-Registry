...
export default function RecentAdditionsTimeline({
  data,
}: {
      ...
      <div className="relative border-l border-border ml-3 space-y-6 pb-2">
        {data.map((contract) => {
          const formattedDate = new Date(
            contract.created_at as string | number,
            ...
            <div key={contract.id as React.Key} className="relative pl-6">
              ...
              <div className="mt-2 text-xs">
                ...
                {(contract.category as string | undefined) && (
                  <span className="ml-2 px-2 py-0.5 rounded border border-border text-muted-foreground">
